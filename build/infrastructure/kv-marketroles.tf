...
module "kv_marketroles" {
  source                          = "git::https://github.com/Energinet-DataHub/green-energy-hub-core.git//terraform/modules/key-vault?ref=1.3.0"
...
module "kvs_marketroles_db_connection_string" {
  source                    = "git::https://github.com/Energinet-DataHub/green-energy-hub-core.git//terraform/modules/key-vault-secret?ref=1.4.0"
