...
{
    public static SettlementType? Map(SettlementMethod? timeSeriesType)
    {
        return timeSeriesType switch
        {
            SettlementMethod.Flex => SettlementType.Flex,
            SettlementMethod.NonProfiled => SettlementType.NonProfiled,
            null => null,
