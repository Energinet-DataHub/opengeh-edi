...
public class WhenAnAcceptedWholesaleServicesRequestIsAvailable : INotificationHandler<WholesaleServicesRequestWasAccepted>
{
    private readonly CommandSchedulerFacade _commandSchedulerFacade;

    public WhenAnAcceptedWholesaleServicesRequestIsAvailable(CommandSchedulerFacade commandSchedulerFacade)
    {
    ...
    public Task Handle(WholesaleServicesRequestWasAccepted notification, CancellationToken cancellationToken)
    {
        ...
        return _commandSchedulerFacade.EnqueueAsync(new AcceptedWholesaleServicesSerieCommand(notification.ProcessId, notification.AcceptedWholesaleServicesSerie));
    }
}
