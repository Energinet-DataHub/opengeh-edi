...
{
    public InitializeAggregatedMeasureDataProcessesCommand(InitializeAggregatedMeasureDataProcessDto dto)
    {
        Dto = dto;
    }

    public InitializeAggregatedMeasureDataProcessDto Dto { get; }
}
