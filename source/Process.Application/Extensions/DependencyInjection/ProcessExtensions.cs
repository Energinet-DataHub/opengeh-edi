...
public static class ProcessExtensions
{
    public static IServiceCollection AddProcessModule(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services
            ...
            .AddTransient<IRequestHandler<AcceptedEnergyResultTimeSerieCommand, Unit>,
                AcceptProcessWhenAcceptedEnergyResultTimeSerieIsAvailable>()
            .AddTransient<IRequestHandler<AcceptedEnergyResultTimeSeriesCommand, Unit>,
                AcceptProcessWhenAcceptedEnergyResultTimeSeriesIsAvailable>()
            ...
            .AddTransient<INotificationHandler<AggregatedTimeSeriesRequestWasAccepted>,
                WhenAnAcceptedAggregatedTimeSeriesRequestIsAvailable>()
