...
namespace Energinet.DataHub.B2B.RSM.RSM029.V3.Response
{
...
#nullable enable
        public DK_ResponseMasterDataConsumerType? BuildPayload(RsmDocument emptyResponse, List<Tuple<string, string>> args)
        {
            ...
            var process = new EnergyContext
            {
                ...
                {
                    Value = args[2].Item2,
                    listAgencyIdentifier = BusinessReasonCodeType_000115ListAgencyIdentifier.Item260,
                },
            };
            var returnResponse = emptyResponse as DK_ResponseMasterDataConsumerType;
...
#nullable disable
        ...
        {
            return "ResponseMasterDataConsumer";
        }
        ...
        {
            return PayloadMasterDataMeteringPointPartyEvent[payloadIndex].OriginalBusinessDocument;
        }
