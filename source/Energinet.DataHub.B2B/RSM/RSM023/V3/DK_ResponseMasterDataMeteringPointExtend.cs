...
namespace Energinet.DataHub.B2B.RSM.RSM023.V3.Response
{
...
#nullable enable
        public DK_ResponseMasterDataMeteringPointType? BuildPayload(RsmDocument emptyResponse, List<Tuple<string, string>> args)
        {
