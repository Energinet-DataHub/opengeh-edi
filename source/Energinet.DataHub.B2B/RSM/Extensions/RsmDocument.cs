...
using Energinet.DataHub.B2B.Classes;
using Energinet.DataHub.B2B.Interface;
using Energinet.DataHub.B2B.Utilities;
...
namespace Energinet.DataHub.B2B.RSM.Extensions
{
    public abstract class RsmDocument : IRsmDocument
    {
        ...
        public void AddRsmInformation(DataHubDto dto, dynamic payload)
        {
        ...
        public abstract void SetPayloads(List<object> payloads);
