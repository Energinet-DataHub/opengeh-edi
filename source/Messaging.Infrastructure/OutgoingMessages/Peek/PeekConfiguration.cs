...
{
    internal static void Configure(IServiceCollection services, IBundleConfiguration bundleConfiguration, IPeekedMessageRepository peekedMessageRepository, IBundlingState bundlingState)
    {
