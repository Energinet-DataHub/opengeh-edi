...
namespace Energinet.DataHub.EDI.OutgoingMessages.Application.MarketDocuments.Json;
...
internal static class JsonHeaderWriter
{
    internal static void Write(OutgoingMessageHeader messageHeader, string documentType, string typeCode, string? reasonCode, Utf8JsonWriter writer)
    {
        ...
        writer.WriteObject(
            ...
            new KeyValuePair<string, string>("value", CimCode.Of(MarketRole.FromCode(messageHeader.ReceiverRole))));
        ...
        writer.WriteObject(
            ...
            new KeyValuePair<string, string>("value", CimCode.Of(MarketRole.FromCode(messageHeader.SenderRole))));
