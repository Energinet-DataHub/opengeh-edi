...
{
    public static class ConfigurationRuleMapper
    {
        public static ValidationRuleConfiguration MapConfigurationRuleToChargesValidationRuleConfiguration(
            RuleConfiguration ruleConfiguration)
        {
            return new ValidationRuleConfiguration(ruleConfiguration.Key!, ruleConfiguration.Value!);
        }
    }
}
