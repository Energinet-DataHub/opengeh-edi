...
using OutgoingMessages.Application.Tests.Fixtures;
using OutgoingMessages.Application.Tests.MarketDocuments.Asserts;
using Xunit;

namespace OutgoingMessages.Application.Tests.MarketDocuments.RejectRequestWholesaleSettlement;

[SuppressMessage("Reliability", "CA2007:Consider calling ConfigureAwait on the awaited task", Justification = "Test")]
