...
/// <summary>
/// The query we must perform on the view.
///
...
/// </summary>
public class EnergyResultViewQuery : DatabricksStatement
{
    private readonly Guid _calculationId;

    public EnergyResultViewQuery(Guid calculationId)
    {
    ...
    public string ModelName => "wholesale_edi_results";

    public string TableName => "energy_result_points_per_ga_v1";
...
WHERE {EnergyResultViewColumnNames.CalculationId} = '{_calculationId}'
