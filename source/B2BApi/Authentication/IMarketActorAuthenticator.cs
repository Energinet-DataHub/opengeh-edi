...
public interface IMarketActorAuthenticator
{
    ...
    /// <param name="actorClientId">Actor id, typically found in the `azp` claim</param>
    bool Authenticate(ActorNumber? actorNumber, ActorRole? actorRole, string? actorClientId);
}
