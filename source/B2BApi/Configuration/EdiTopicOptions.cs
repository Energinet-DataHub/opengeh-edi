...
public class EdiTopicOptions
{
    ...
    /// uses this to signal EDI to enqueue messages for BRS 023/027.
    /// </summary>
    [Required(AllowEmptyStrings = false)]
    ...
    /// <summary>
    /// Enqueue BRS 021 messages subscription name, retrieved from application settings. The Process Manager
    ...
    /// <summary>
    /// Enqueue BRS 024 messages subscription name, retrieved from application settings. The Process Manager
    /// uses this to signal EDI to enqueue messages for BRS 024.
    /// </summary>
    [Required(AllowEmptyStrings = false)]
