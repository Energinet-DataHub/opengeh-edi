...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM008.V3.Confirm
{
    public partial class DK_ConfirmCancelEndOfSupplyType : RsmDocument
    {
        ...
        {
            return "ConfirmCancelEndOfSupply";
        }
