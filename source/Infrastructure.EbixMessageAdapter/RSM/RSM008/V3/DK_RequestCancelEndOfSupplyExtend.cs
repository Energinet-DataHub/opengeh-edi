...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM008.V3.Request
{
    public partial class DK_RequestCancelEndOfSupplyType : RsmDocument
    {
        ...
        {
            return "RequestCancelEndOfSupply";
        }
