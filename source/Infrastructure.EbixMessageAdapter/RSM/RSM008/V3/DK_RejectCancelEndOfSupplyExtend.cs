...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM008.V3.Reject
{
    public partial class DK_RejectCancelEndOfSupplyType : RsmDocument
    {
        ...
        {
            return "RejectCancelEndOfSupply";
        }
