...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM002.V3.Reject
{
    public partial class DK_RejectCancelChangeOfSupplierType : ResponseRsmDocument
    {
        ...
        {
            return "RejectCancelChangeOfSupplier";
        }
