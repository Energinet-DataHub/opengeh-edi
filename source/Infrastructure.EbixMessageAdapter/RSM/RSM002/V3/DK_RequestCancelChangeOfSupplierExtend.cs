...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM002.V3.Request
{
    public partial class DK_RequestCancelChangeOfSupplierType : ResponseRsmDocument
    {
        ...
        {
            return "RequestCancelChangeOfSupplier";
        }
