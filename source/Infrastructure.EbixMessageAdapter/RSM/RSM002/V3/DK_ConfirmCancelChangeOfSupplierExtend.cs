...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM002.V3.Confirm
{
    public partial class DK_ConfirmCancelChangeOfSupplierType : ResponseRsmDocument
    {
        ...
        {
            return "ConfirmCancelChangeOfSupplier";
        }
