...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM032.V3.Response
{
    public partial class DK_ResponseMasterDataChargeType : RsmDocument
    {
        ...
        {
            return "ResponseMasterDataCharge";
        }
