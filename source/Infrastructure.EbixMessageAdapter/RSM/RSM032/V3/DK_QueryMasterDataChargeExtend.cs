...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM032.V3.Request
{
    public partial class DK_QueryMasterDataChargeType : RsmDocument
    {
        ...
        {
            return PayloadChargeEvent[payloadIndex].RelatedChargeChargeInformation.ObservationTimeSeriesPeriod.Start;
        }
