...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM019.V3.Notify
{
    public partial class DK_NotifyAggregatedWholesaleServicesType : RsmDocument
    {
        ...
        {
            return "NotifyAggregatedWholesaleServices";
        }
