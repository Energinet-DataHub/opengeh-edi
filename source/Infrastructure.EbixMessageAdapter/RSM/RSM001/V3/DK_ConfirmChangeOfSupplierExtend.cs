...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM001.V3.Response
{
    public partial class DK_ConfirmChangeOfSupplierType : RsmDocument
    {
        ...
        {
            return "ConfirmChangeOfSupplierType";
        }
