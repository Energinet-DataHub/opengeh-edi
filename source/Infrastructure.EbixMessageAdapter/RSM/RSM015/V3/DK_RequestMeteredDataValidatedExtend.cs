...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM015.V3.Request
{
    public partial class DK_RequestMeteredDataValidatedType : RsmDocument
    {
        ...
        {
            return "RequestMeteredDataValidated";
        }
