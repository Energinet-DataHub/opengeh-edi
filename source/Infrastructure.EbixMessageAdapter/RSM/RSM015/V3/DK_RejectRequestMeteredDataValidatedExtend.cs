...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM015.V3.Reject
{
    public partial class DK_RejectRequestMeteredDataValidatedType : RsmDocument
    {
        ...
        {
            return "RejectRequestMeteredDataValidated";
        }
