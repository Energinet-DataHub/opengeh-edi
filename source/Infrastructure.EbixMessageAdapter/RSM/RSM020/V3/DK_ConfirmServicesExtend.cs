...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM020.V3.Confirm
{
    public partial class DK_ConfirmServicesType : RsmDocument
    {
        ...
        {
            return PayloadResponseEvent[payloadIndex].MeteringPointDomainLocation.Identification.Value;
        }
        ...
        {
            return PayloadResponseEvent[payloadIndex].StatusType.Value;
        }
