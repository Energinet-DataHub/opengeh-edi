...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM016.V3.Reject
{
    public partial class DK_RejectRequestMeteredDataAggregatedType : RsmDocument
    {
        ...
        {
            return "RejectRequestMeteredDataAggregated";
        }
