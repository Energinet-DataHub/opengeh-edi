...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM021.V3.Reject
{
    public partial class DK_RejectUpdateMasterDataMeteringPointType : ResponseRsmDocument
    {
        ...
        {
            return "RejectUpdateMasterDataMeteringPoint";
        }
