...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM021.V3.Confirm
{
    public partial class DK_ConfirmUpdateMasterDataMeteringPointType : ResponseRsmDocument
    {
        ...
        {
            return "ConfirmUpdateMasterDataMeteringPoint";
        }
        ...
        {
            return PayloadChargeEvent[payloadIndex].MeteringPointDomainLocation.Identification.Value;
        }
