...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM033.V3.Request
{
    public partial class DK_RequestUpdateChargeInformationType : RsmDocument
    {
        ...
        {
            return "RequestUpdateChargeInformation";
        }
