...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM033.V3.Reject
{
    public partial class DK_RejectUpdateChargeInformationType : ResponseRsmDocument
    {
        ...
        {
            return "RejectUpdateChargeInformation";
        }
