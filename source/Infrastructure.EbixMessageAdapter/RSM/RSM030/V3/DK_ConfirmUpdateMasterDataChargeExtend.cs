...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM030.V3.Confirm
{
    public partial class DK_ConfirmUpdateMasterDataChargeType : ResponseRsmDocument
    {
        ...
        {
            return "ConfirmUpdateMasterDataCharge";
        }
