...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM030.V3.Reject
{
    public partial class DK_RejectUpdateMasterDataChargeType : ResponseRsmDocument
    {
        ...
        {
            return "RejectUpdateMasterDataCharge";
        }
