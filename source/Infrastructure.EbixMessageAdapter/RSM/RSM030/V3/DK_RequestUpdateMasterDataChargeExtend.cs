...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM030.V3.Request
{
    public partial class DK_RequestUpdateMasterDataChargeType : RsmDocument
    {
        ...
        {
            return "RequestUpdateMasterDataCharge";
        }
