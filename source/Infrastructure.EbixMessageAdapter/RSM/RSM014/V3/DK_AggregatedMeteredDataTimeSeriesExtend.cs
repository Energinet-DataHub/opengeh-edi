...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM014.V3.Notify
{
    public partial class DK_AggregatedMeteredDataTimeSeriesType : RsmDocument
    {
        ...
        {
            return "AggregatedMeteredDataTimeSeries";
        }
