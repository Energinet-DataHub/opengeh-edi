...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM003.V3.Reject
{
    public partial class DK_RejectReallocateChangeOfSupplierType : RsmDocument
    {
        ...
        {
            return "RejectReallocateChangeOfSupplier";
        }
