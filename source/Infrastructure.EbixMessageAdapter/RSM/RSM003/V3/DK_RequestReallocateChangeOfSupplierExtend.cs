...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM003.V3.Request
{
    public partial class DK_RequestReallocateChangeOfSupplierType : RsmDocument
    {
        ...
        {
            return "RequestReallocateChangeOfSupplier";
        }
        ...
        {
            return PayloadMPEvent[payloadIndex].StartOfOccurrence;
        }
    }
}
