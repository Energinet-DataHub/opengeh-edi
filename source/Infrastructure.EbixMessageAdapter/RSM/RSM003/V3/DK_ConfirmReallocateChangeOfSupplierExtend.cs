...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM003.V3.Confirm
{
    public partial class DK_ConfirmReallocateChangeOfSupplierType : RsmDocument
    {
        ...
        {
            return "ConfirmReallocateChangeOfSupplier";
        }
