...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM004.V3.Notify
{
    public partial class DK_NotifyChangeOfSupplierType : RsmDocument
    {
        ...
        {
            return PayloadMPEvent[payloadIndex].Item;
        }
    }
}
