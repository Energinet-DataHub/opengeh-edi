...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM035.V3.Response
{
    public partial class DK_ResponseQueryChargeInformationType : RsmDocument
    {
        ...
        {
            return "ResponseQueryChargeInformation";
        }
        ...
        {
            return PayloadChargeEvent[payloadIndex].RelatedChargeChargeInformation.FirstOrDefault()?.Occurrence;
        }
