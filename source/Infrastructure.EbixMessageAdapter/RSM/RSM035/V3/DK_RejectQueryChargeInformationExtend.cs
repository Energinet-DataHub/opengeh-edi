...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM035.V3.Reject
{
    public partial class DK_RejectQueryChargeInformationType : RsmDocument
    {
        ...
        {
            return "RejectQueryChargeInformation";
        }
