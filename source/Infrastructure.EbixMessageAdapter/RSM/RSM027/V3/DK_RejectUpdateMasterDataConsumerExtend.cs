...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM027.V3.Reject
{
    public partial class DK_RejectUpdateMasterDataConsumerType : RsmDocument
    {
        ...
        {
            return "RejectUpdateMasterDataConsumer";
        }
