...
namespace Energinet.DataHub.EDI.Infrastructure.EbixMessageAdapter.RSM.RSM017.V3.Request
{
    public partial class DK_RequestAggregatedBillingInformationType : RsmDocument
    {
        public override int PayloadCount
        {
            get { return PayloadRequestChargeInformation.Length; }
        }

        public override void AddPayload(object payload)
        {
            var payloads = PayloadRequestChargeInformation.ToList();
            payloads.Add((RequestChargeInformation)payload);
            PayloadRequestChargeInformation = payloads.ToArray();
        }
        ...
        {
            return "RequestAggregatedBillingInformation";
        }
        ...
        {
            return PayloadRequestChargeInformation[payloadIndex].ObservationTimeSeriesPeriod.Start;
        }

        public override object GetPayload(int payloadIndex)
        {
            return PayloadRequestChargeInformation[payloadIndex];
        }

        public override string GetPayloadMessageId(int payloadIndex)
        {
            return PayloadRequestChargeInformation[payloadIndex].Identification;
        }
        ...
        {
            PayloadRequestChargeInformation = payloads.Cast<RequestChargeInformation>().ToArray();
        }
    }
}
