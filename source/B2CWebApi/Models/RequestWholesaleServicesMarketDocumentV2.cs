...
public record RequestWholesaleSettlementSeriesV2(
    ...
    string? Resolution,
    string? ChargeOwner,
    IReadOnlyCollection<RequestWholesaleSettlementChargeTypeV2> ChargeTypes);

public sealed record RequestWholesaleSettlementChargeTypeV2(string? Id, string? Type);
