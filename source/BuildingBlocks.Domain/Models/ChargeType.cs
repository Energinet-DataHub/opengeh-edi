...
{
    public static readonly ChargeType Subscription = new(0, nameof(Subscription), "D01");
    public static readonly ChargeType Fee = new(1, nameof(Fee), "D02");
    public static readonly ChargeType Tariff = new(2, nameof(Tariff), "D03");
