...
public static class BusinessReasonAndSettlementVersionMapper
{
    public static (BusinessReason BusinessReason, SettlementVersion? SettlementVersion)
        FromDeltaTableValue(
            string calculationType)
    {
        return calculationType switch
        {
            ...
            DeltaTableCalculationType.FirstCorrectionSettlement => (BusinessReason.Correction,
                SettlementVersion.FirstCorrection),
            DeltaTableCalculationType.SecondCorrectionSettlement => (BusinessReason.Correction,
                SettlementVersion.SecondCorrection),
            DeltaTableCalculationType.ThirdCorrectionSettlement => (BusinessReason.Correction,
                SettlementVersion.ThirdCorrection),
