        ...
        string table)
    {
        ...
        var sqlConstraint =
                $"""
                     ...
                     {(meteringPointTypeDeltaTableValue is not null ? $"{table}.{DatabricksContract.GetSettlementMethodColumnName()} = '{settlementMethodDeltaTableValue ?? "null"}' AND " : string.Empty)} 
