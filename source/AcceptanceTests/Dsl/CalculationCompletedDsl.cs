...
public sealed class CalculationCompletedDsl
{
    ...
    internal CalculationCompletedDsl(AcceptanceTestFixture fixture, EdiDriver ediDriver, EdiDatabaseDriver ediDatabaseDriver, WholesaleDriver wholesaleDriver)
    {
