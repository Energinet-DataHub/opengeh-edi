...
public class B2CWebApiAuditLogTests : IAsyncLifetime
{
    ...
    public static IEnumerable<object[]> GetB2CWebApiRequests()
    {
        ...
        [
            ...
            [B2CWebApiRequests.CreateRequestAggregatedMeasureDataRequestTemp(), ActorRole.EnergySupplier.Name, AuditLogActivity.RequestEnergyResults],
            ...
            [B2CWebApiRequests.CreateMeteringPointArchivedMessageSearchRequest(), _datahubAdministratorRole, AuditLogActivity.MeteringPointArchivedMessageSearch],
            [B2CWebApiRequests.CreateMeteringPointArchivedMessageGetDocumentRequest(), _datahubAdministratorRole, AuditLogActivity.MeteringPointArchivedMessageGet],
        ];
    }
