...
public sealed class PointToPointEventServiceBusMessage
{
    internal PointToPointEventServiceBusMessage(Guid messageId, string subject, IReadOnlyDictionary<string, object> applicationProperties, BinaryData body)
    {
        MessageId = messageId;
        Subject = subject;
    ...
    public static PointToPointEventServiceBusMessage Create(byte[] message, IReadOnlyDictionary<string, object> bindingData)
    {
        ...
        return new PointToPointEventServiceBusMessage(
