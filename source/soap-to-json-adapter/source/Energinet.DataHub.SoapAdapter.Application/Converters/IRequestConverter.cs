...
namespace Energinet.DataHub.SoapAdapter.Application.Converters
{
    ...
    public interface IRequestConverter
    {
        ...
        /// <param name="correlationId">The unique correlation id created the systems entry point</param>
        ValueTask ConvertAsync(Stream input, Stream output, string correlationId);
    }
}
