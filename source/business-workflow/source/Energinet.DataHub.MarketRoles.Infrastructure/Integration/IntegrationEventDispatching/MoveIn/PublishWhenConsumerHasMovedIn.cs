...
{
    public class PublishWhenConsumerHasMovedIn : INotificationHandler<ConsumerMovedIn>
    {
        private readonly IOutbox _outbox;
        private readonly IOutboxMessageFactory _outboxMessageFactory;

        public PublishWhenConsumerHasMovedIn(IOutbox outbox, IOutboxMessageFactory outboxMessageFactory)
        {
        ...
        public Task Handle(ConsumerMovedIn notification, CancellationToken cancellationToken)
        {
            ...
            var integrationEvent = new ConsumerMovedInIntegrationEvent(
                notification.GsrnNumber,
                notification.MoveInDate);
