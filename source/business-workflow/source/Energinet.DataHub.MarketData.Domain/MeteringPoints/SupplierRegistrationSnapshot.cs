...
{
    public class SupplierRegistrationSnapshot
    {
        public SupplierRegistrationSnapshot(string energySupplierId, Instant? supplyStartDate, Instant? endOfSupplyDate, string processId)
        {
        ...
        public Instant? EndOfSupplyDate { get; }
