...
namespace Energinet.DataHub.MarketData.Application.ChangeOfSupplier.IntegrationEvents
{
    public class SupplierChangeRegistered : IIntegrationEvent
    {
...
#pragma warning disable 8618
        public SupplierChangeRegistered()
#pragma warning restore 8618
        {
        }

        public SupplierChangeRegistered(string marketEvaluationPointMrid)
        {
