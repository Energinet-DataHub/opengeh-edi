...
internal static class JsonHeaderWriter
{
    internal static void Write(MessageHeader messageHeader, string documentType, string typeCode, string? reasonCode, JsonTextWriter writer)
    {
        ...
        writer.WriteStartObject();
        writer.WritePropertyName("value");
        writer.WriteValue(CimCode.Of(ProcessType.From(messageHeader.ProcessType)));
        writer.WriteEndObject();
        ...
        writer.WriteStartObject();
        writer.WritePropertyName("value");
        writer.WriteValue(CimCode.Of(EnumerationType.FromName<MarketRole>(messageHeader.ReceiverRole)));
        writer.WriteEndObject();
        ...
        writer.WriteStartObject();
        writer.WritePropertyName("value");
        writer.WriteValue(CimCode.Of(EnumerationType.FromName<MarketRole>(messageHeader.SenderRole)));
        writer.WriteEndObject();
