...
public class RejectedAggregatedMeasureProcessIsAvailable : INotificationHandler<AggregatedMeasureProcessWasRejected>
{
    private readonly ICommandScheduler _commandScheduler;

    public RejectedAggregatedMeasureProcessIsAvailable(ICommandScheduler commandScheduler)
    {
