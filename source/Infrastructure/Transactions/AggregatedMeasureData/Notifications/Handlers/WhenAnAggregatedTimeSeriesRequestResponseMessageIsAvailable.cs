...
public class WhenAnAggregatedTimeSeriesRequestResponseMessageIsAvailable : INotificationHandler<AggregatedTimeSerieRequestResponse>
{
    private readonly CommandSchedulerFacade _commandSchedulerFacade;

    public WhenAnAggregatedTimeSeriesRequestResponseMessageIsAvailable(CommandSchedulerFacade commandSchedulerFacade)
    {
    ...
    public Task Handle(AggregatedTimeSerieRequestResponse notification, CancellationToken cancellationToken)
    {
        ...
        return _commandSchedulerFacade.EnqueueAsync(new ResponseMessageAggregatedTimeSerie(notification.ProcessId, notification.AggregatedTimeSerie));
    }
}
