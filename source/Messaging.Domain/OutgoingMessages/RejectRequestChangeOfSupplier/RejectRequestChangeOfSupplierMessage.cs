...
public class RejectRequestChangeOfSupplierMessage : OutgoingMessage
{
    ...
    public RejectRequestChangeOfSupplierMessage(ActorNumber receiverId, string transactionId, string processType, ActorNumber senderId, MarketRole senderRole, MarketActivityRecord marketActivityRecord)
        : base(DocumentType.RejectRequestChangeOfSupplier, receiverId, transactionId, processType, MarketRole.EnergySupplier, senderId, senderRole, JsonSerializer.Serialize(marketActivityRecord))
    {
