...
public sealed class EdiQualityMapperTests
{
#pragma warning disable CA1034
    public sealed class QuantityQualityCollectionToEdiQuality
#pragma warning restore CA1034
    {
        public static IEnumerable<object[]> QualityMappingData()
        {
        ...
        {
            return Enum.GetValues<EnergyResultProducedV2.Types.QuantityQuality>().Select(e => new[] { (object)e });
        }
...
#pragma warning disable CS8604 // Possible null reference argument.
            Assert.Throws<ArgumentNullException>(() => EdiQualityMapper.QuantityQualityCollectionToEdiQuality(quality));
#pragma warning restore CS8604 // Possible null reference argument.
        }

        [Theory]
        [MemberData(nameof(QualityMappingData))]
        public void Maps_quantity_quality_to_edi_quality_in_accordance_with_the_rules(
            ...
            CalculatedQuantityQuality expectedCalculatedQuantityCalculatedQuantityQualityResult)
        {
            // Act
            var actual = EdiQualityMapper.QuantityQualityCollectionToEdiQuality(qualitySetFromWholesale);

            // Assert
            Assert.Equal(expectedCalculatedQuantityCalculatedQuantityQualityResult, actual);
        }
        ...
        {
            // Act
            EdiQualityMapper.QuantityQualityCollectionToEdiQuality(new[] { quantityQuality });
        }
    }
}
