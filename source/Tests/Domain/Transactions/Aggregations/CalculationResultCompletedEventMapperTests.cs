...
public class CalculationResultCompletedEventMapperTests
{
    ...
    public CalculationResultCompletedEventMapperTests(CalculationResultCompletedEventMapperSpy calculationResultCompletedEventMapperSpy)
    {
    ...
    public void Test_with()
    {
        ...
        //.MapProcessType(ProcessType.Aggregation);
    }
