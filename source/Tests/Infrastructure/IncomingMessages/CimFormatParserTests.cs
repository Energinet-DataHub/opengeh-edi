...
{
    [Theory]
    [InlineData("application/json", nameof(DocumentFormat.Json))]
    [InlineData("application/json; charset=utf-8", nameof(DocumentFormat.Json))]
    [InlineData("application/xml; charset=utf-8", nameof(DocumentFormat.Xml))]
    [InlineData("application/xml", nameof(DocumentFormat.Xml))]
    [InlineData("application/xml ", nameof(DocumentFormat.Xml))]
