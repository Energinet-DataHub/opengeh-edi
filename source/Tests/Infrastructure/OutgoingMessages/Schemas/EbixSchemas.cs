...
namespace Energinet.DataHub.EDI.Tests.Infrastructure.OutgoingMessages.Schemas;

public class EbixSchemas : SchemaBase, ISchema
{
    private static readonly string _schemaPath =
        $"Infrastructure{Path.DirectorySeparatorChar}"
        + $"OutgoingMessages{Path.DirectorySeparatorChar}"
        + $"Schemas{Path.DirectorySeparatorChar}"
        + $"Ebix{Path.DirectorySeparatorChar}"
