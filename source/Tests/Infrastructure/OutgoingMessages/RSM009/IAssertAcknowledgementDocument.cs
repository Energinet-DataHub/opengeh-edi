...
public interface IAssertAcknowledgementDocument
{
    IAssertAcknowledgementDocument HasMessageId(MessageId messageId);

    IAssertAcknowledgementDocument HasSenderId(ActorNumber senderId);

    IAssertAcknowledgementDocument HasSenderRole(ActorRole senderRole);

    IAssertAcknowledgementDocument HasReceiverId(ActorNumber receiverId);
