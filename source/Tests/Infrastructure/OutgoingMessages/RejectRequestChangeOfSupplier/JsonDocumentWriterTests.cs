...
public class JsonDocumentWriterTests
{
    ...
    private readonly JsonDocumentValidator _documentValidator;
    ...
    {
        var schema = await _documentValidator.GetSchemaAsync<JsonSchema>("rejectrequestchangeofsupplier", "0").ConfigureAwait(false);
