...
public class CalculationTypeMapperTests
{
    ...
    {
        foreach (var number in Enum.GetValues(typeof(EnergyResultProducedV2.Types.CalculationType)))
        {
    ...
    public void Ensure_handling_all_process_types(EnergyResultProducedV2.Types.CalculationType calculationType)
    {
        // Act
