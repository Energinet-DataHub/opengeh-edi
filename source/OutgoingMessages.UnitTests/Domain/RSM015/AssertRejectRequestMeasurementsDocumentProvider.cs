...
public static class AssertRejectRequestMeasurementsDocumentProvider
{
    public static IAssertRejectRequestMeasurementsDocument AssertDocument(
        Stream document,
        DocumentFormat documentFormat)
    {
        if (documentFormat == DocumentFormat.Ebix)
        {
            ...
            return new AssertRejectRequestRequestMeasurementsEbixDocument(assertEbixDocument);
        }
        ...
        if (documentFormat == DocumentFormat.Xml)
        {
            ...
            return new AssertRejectRequestRequestMeasurementsXmlDocument(assertXmlDocument);
        }

        if (documentFormat == DocumentFormat.Json)
        {
            return new AssertRejectRequestRequestMeasurementsJsonDocument(document);
        }
