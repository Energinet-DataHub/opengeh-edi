INSERT INTO [b2b].[Reasons] (Id, ErrorCode, Code, Text, Lang)
...
INSERT INTO [b2b].[Reasons] (Id, ErrorCode, Code, Text, Lang)
VALUES (N'97EE4769-4357-4B33-B3EA-49F1F832281E', 'ConsumerIdentifierIsRequired', 'D64', 'Kunde ID er påkrævet', 'en');
INSERT INTO [b2b].[Reasons] (Id, ErrorCode, Code, Text, Lang)
