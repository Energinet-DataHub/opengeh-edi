...
/// <summary>
/// Write a CIM XML document
/// </summary>
public interface IDocumentWriter<TDocumentType>
{
    /// <summary>
    ...
    Task WriteAsync(IReadOnlyCollection<string> marketActivityPayloads, XmlWriter writer);
}
