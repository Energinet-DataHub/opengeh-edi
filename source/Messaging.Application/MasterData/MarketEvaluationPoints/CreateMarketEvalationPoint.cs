...
public class CreateMarketEvalationPoint
{
    [JsonConstructor]
    public CreateMarketEvalationPoint(string marketEvaluationPointNumber, string energySupplierNumber, string gridOperatorId)
    {
