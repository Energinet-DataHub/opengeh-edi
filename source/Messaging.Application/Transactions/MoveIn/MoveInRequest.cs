...
{
    public MoveInRequest(string? consumerName, string? energySupplierGlnNumber, string accountingPointGsrnNumber, string startDate, string? consumerId, string? consumerIdType)
    {
