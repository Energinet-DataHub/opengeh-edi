...
{
    public List<MeteredDataForMeteringPointMarketActivityRecord> TransformJsonMessage(
        Instant creation,
        List<TimeSeries> timeSeries)
    {
        return CreateMeteredDataForMeteringPointMarketActivityRecords(creation, timeSeries);
    }
    ...
    private List<MeteredDataForMeteringPointMarketActivityRecord>
        CreateMeteredDataForMeteringPointMarketActivityRecords(Instant creation, List<TimeSeries> timeSeries)
    {
        var meteredDataForMeteringPointMarketActivityRecords = timeSeries.Select(ts => new MeteredDataForMeteringPointMarketActivityRecord(
