...
public class B2BApiAppFixture : IAsyncLifetime
{
    ...
    private FunctionAppHostSettings CreateAppHostSettings(string csprojName, ref int port)
    {
        ...
        // maxQueuePollingInterval ref: https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-bindings?tabs=python-v2%2Cin-process%2C2x-durable-functions&pivots=programming-language-csharp#hostjson-settings
        appHostSettings.ProcessEnvironmentVariables.Add(
