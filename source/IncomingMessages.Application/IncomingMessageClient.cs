        ...
        CancellationToken cancellationToken)
    {
        await _archivedMessagesClient.CreateAsync(
            new ArchivedMessage(
                ...
                ActorNumber.Create(requestAggregatedMeasureDataMarketMessageParserResult.Dto!.SenderNumber),
                ActorNumber.Create(requestAggregatedMeasureDataMarketMessageParserResult.Dto!.ReceiverNumber),
