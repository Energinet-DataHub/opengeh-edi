...
public static class IncomingMessagesExtensions
{
    public static IServiceCollection AddIncomingMessagesModule(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services
            ...
            .AddScoped<AggregatedMeasureDataRequestMessageValidator>()
            .AddScoped<IProcessTypeValidator, ProcessTypeValidator>()
            .AddScoped<IMessageTypeValidator, MessageTypeValidator>()
            .AddScoped<IBusinessTypeValidator, BusinessTypeValidator>()
            .AddScoped<IReceiverValidator, CalculationResponsibleReceiverVerification>()
