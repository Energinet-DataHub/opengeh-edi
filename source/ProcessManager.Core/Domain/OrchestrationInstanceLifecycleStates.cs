...
public enum OrchestrationInstanceLifecycleStates
{
    ...
    /// <summary>
    /// A Durable Functions activity has marked the orchestration instance as started.
    /// </summary>
    Running = 3,

    /// <summary>
    /// A Durable Functions activity has marked the orchestration instance as terminated.
