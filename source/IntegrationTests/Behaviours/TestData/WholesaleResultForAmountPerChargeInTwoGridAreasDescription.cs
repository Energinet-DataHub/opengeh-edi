        ...
        {
            {
                "803", new(
                    ...
                    Points: new List<WholesaleServicesRequestSeries.Types.Point>()
                    {
                        new()
                        {
                            Quantity = DecimalValue.FromDecimal(1117.728m),
                            Price = DecimalValue.FromDecimal(1.757m),
                            Amount = DecimalValue.FromDecimal(1963.846m),
                        ...
                        new()
                        {
                            Quantity = DecimalValue.FromDecimal(0.000m),
                            Price = DecimalValue.FromDecimal(1.757m),
                            Amount = DecimalValue.FromDecimal(0.000m),
                        ...
                        new()
                        {
                            Quantity = DecimalValue.FromDecimal(1002.720m),
                            Price = DecimalValue.FromDecimal(1.757m),
                            Amount = DecimalValue.FromDecimal(1761.777m),
                            QuantityQualities = { QuantityQuality.Calculated },
                        },
                        new()
                        {
