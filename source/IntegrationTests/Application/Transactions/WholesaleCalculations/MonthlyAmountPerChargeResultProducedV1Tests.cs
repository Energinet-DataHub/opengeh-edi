...
public class MonthlyAmountPerChargeResultProducedV1Tests : TestBase
{
    ...
    public async Task MonthlyAmountPerChargeResultProducedV1Processor_creates_outgoingMessage_with_expected_values()
    {
        ...
        message
            ...
            .HasMessageRecordValue<WholesaleServicesSeries>(wholesaleCalculation => wholesaleCalculation.QuantityUnit, MeasurementUnit.Kwh)
    ...
    [Fact]
    public async Task
        MonthlyAmountPerChargeResultProducedV1Processor_creates_outgoing_message_to_energy_supplier_and_grid_owner_if_tax_and_charge_owner_is_grid_owner()
    {
    ...
    [Fact]
    public async Task
        MonthlyAmountPerChargeResultProducedV1Processor_creates_outgoing_message_to_energy_supplier_and_grid_owner_if_tax_and_charge_owner_is_tso()
    {
        await new GridAreaBuilder()
            .WithGridAreaCode("805")
            .WithActorNumber(ActorNumber.Create("8200000007740"))
