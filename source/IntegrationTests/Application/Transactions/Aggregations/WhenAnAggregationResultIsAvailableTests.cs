...
public class WhenAnAggregationResultIsAvailableTests : TestBase
{
    ...
    public async Task Non_profiled_consumption_result_is_sent_the_energy_supplier()
    {
        ...
        await HandleIntegrationEventAsync(CalculationResultCompleted.EventName, _eventBuilder.Build());
    ...
    private async Task HandleIntegrationEventAsync(string eventType, CalculationResultCompleted calculationResultCompleted)
    {
