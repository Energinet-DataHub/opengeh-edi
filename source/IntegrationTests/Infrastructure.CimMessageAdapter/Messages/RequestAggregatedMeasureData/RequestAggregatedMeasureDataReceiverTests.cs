...
#pragma warning disable CA2007
    ...
    public async Task Receiver_id_must_be_unknown()
    {
        ...
        var result = await CreateMessageReceiver().ReceiveAsync(marketDocument, CancellationToken.None).ConfigureAwait(false);
    ...
    public async Task Series_can_have_same_transaction_ids_across_senders()
    {
        ...
        var messageParserResult = await ParseMessageAsync(message).ConfigureAwait(false);
        var marketDocument = RequestAggregatedMeasureDocumentFactory.Created(messageParserResult.IncomingMarketDocument!);
        var resultFromFirstMessage = await CreateMessageReceiver().ReceiveAsync(marketDocument, CancellationToken.None).ConfigureAwait(false);
        ...
        var resultFromSecondMessage = await CreateMessageReceiver().ReceiveAsync(marketDocument2, CancellationToken.None).ConfigureAwait(false);
    ...
    public async Task Message_id_may_be_reused_across_senders()
    {
        ...
        var result01 = await CreateMessageReceiver().ReceiveAsync(marketDocument, CancellationToken.None).ConfigureAwait(false);
        ...
        var result02 = await CreateMessageReceiver().ReceiveAsync(marketDocument02, CancellationToken.None).ConfigureAwait(false);
    ...
    public async Task Message_ids_must_be_unique_for_sender()
    {
        ...
        var marketDocument = RequestAggregatedMeasureDocumentFactory.Created(messageParserResult01.IncomingMarketDocument!);
        var result01 = await CreateMessageReceiver().ReceiveAsync(marketDocument, CancellationToken.None).ConfigureAwait(false);
        var result02 = await CreateMessageReceiver().ReceiveAsync(marketDocument, CancellationToken.None).ConfigureAwait(false);
    ...
    public async Task Transaction_ids_are_unique_across_scopes()
    {
        ...
        // Act
        var marketDocument = RequestAggregatedMeasureDocumentFactory.Created(messageParserResult.IncomingMarketDocument!);
        var receivedResult1 = CreateMessageReceiver().ReceiveAsync(marketDocument, CancellationToken.None);
        var receivedResult2 = CreateMessageReceiver().ReceiveAsync(marketDocument, CancellationToken.None);
    ...
    public async Task Transaction_id_and_message_id_are_not_registered_when_duplicated_across_scopes()
    {
        ...
        // Act
        var receivedResult1 = CreateMessageReceiver().ReceiveAsync(marketDocument01, CancellationToken.None);
        var receivedResult2 = CreateMessageReceiver().ReceiveAsync(marketDocument02, CancellationToken.None);
