...
public static class FluentAssertionExtensions
{
     ...
     * Here is an example: https://regex101.com/r/HhGUH4/2
     * The regex thinks the string is a CIM code if:
     * 1. The string MUST start with A, D, E, P, K, H, M, S
     * 2. The string MUST be followed by 2 characters
     * 3. The string CAN be followed by 0 to 2 characters
     * So in total: The string start with A, D, E, P, K, H, M or S and has a total length of 3 to 5 characters
