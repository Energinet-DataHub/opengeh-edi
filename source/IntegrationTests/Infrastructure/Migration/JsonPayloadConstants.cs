...
{
    public const string OneTimeSeries = """
       {
    ...
    public const string InvalidMixOfQuantitiesAndQuantityMissingIndicatorTrueAndQualityNull = """
        {
            "MeteredDataTimeSeriesDH3": {
                "Header": {
                    "MessageId": "13255043",
                    "DocumentType": "E66",
                    "Creation": "2024-01-17T07:55:33Z",
                    "EnergyBusinessProcess": "D42",
                    "EnergyIndustryClassification": "23",
                    "SenderIdentification": {
                        "SchemeAgencyIdentifier": "9",
                ...
                "TimeSeries": [
                    {
                        "TimeSeriesId": "74634299_86192543",
                        "OriginalMessageId": "d221605be3744015aed832614accb580",
                        "OriginalTimeSeriesId": "83521745ef4f4ada83f2115dda402e31",
                        "EnergyTimeSeriesFunction": "9",
                        "EnergyTimeSeriesProduct": "8716867000030",
                        "EnergyTimeSeriesMeasureUnit": "KWH",
                        "TypeOfMP": "E17",
                        "SettlementMethod": "D01",
                        "AggregationCriteria": {
                            "MeteringPointId": "571051839308770694"
                        },
                        "Observation": [
                            {
                                "Position": 1,
                        ...
                        "TimeSeriesPeriod": {
                            "ResolutionDuration": "PT1H",
                            "Start": "2023-12-26T23:00:00Z",
                            "End": "2023-12-27T23:00:00Z"
                        },
                        "TransactionInsertDate": "2024-01-17T08:55:14Z",
                        "TimeSeriesStatus": "2"
                    }
                ]
            }
    ...
    public const string InvalidJsonNoOriginalMessageAndTimeSeriesId = """
        {
            "MeteredDataTimeSeriesDH3": {
                "Header": {
                    "MessageId": "13255042",
