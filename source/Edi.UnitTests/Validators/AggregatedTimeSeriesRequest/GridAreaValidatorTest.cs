...
// using FluentAssertions.Execution; TODO: LRN
// using Moq;
// using NodaTime;
// using Xunit;
//
...
//         [Frozen] Mock<IMasterDataClient> gridAreaOwnerRepository,
//         GridAreaValidationRule sut)
//     {
//         // Arrange
//         var gridAreaCode = "123";
//
//         gridAreaOwnerRepository.Setup(repo => repo.TryGetGridOwnerForGridAreaCodeAsync(gridAreaCode, It.IsAny<CancellationToken>()))
//             .ReturnsAsync(new GridAreaOwnerDto(
//                 Guid.NewGuid(),
//                 gridAreaCode,
//                 ValidGlnNumber,
//                 Instant.MinValue,
